...
const summary = async (req, res) => {
  ...
  const [productCount, customerCount, stockByProduct, inventorySummary, allSales, todaySales, allPurchases] = await Promise.all([
  ...
  res.json({
    ...
    data: {
      ...
      totalCashProfit: Math.round(totalCashProfit),
      totalUpiProfit: Math.round(totalUpiProfit),
      todayCashProfit: Math.round(todayCashProfit),
